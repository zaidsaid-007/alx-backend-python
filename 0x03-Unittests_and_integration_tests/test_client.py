...
class TestGithubOrgClient(unittest.TestCase):
    ...
    def test_org(self, org_name, mock_json):
        ...
        Returns:
            ok if it succeeds fail otherwise test that GithubOrgClient.org
    ...
    def test_public_repos_url(self, name, result):
        """
        test_public_repos_url - function to test the public repos url
        Arguments:
            nothing
        Returns:
            ok if it succeeded fail otherwise
        """
...
class TestIntegrationGithubOrgClient(unittest.TestCase):
    """an integration test for GitHub org client"""
